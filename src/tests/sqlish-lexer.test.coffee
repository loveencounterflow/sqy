...
@[ "basic" ] = ( T, done ) ->
  probes_and_matchers = [
    ...
    ["select fields *1: set valign to top;","select,fields,star/'*',coldigits/'1',colon/':',set,valign,to,edge/'top',semicolon/';'"]
    ["select fields *: set valign to top;","select,fields,star/'*',colon/':',set,valign,to,edge/'top',semicolon/';'"]
    ["select fields *..*: set valign to top;","select,fields,star/'*',upto/'..',star/'*',colon/':',set,valign,to,edge/'top',semicolon/';'"]
    ["select fields *: set valign to top;","select,fields,star/'*',colon/':',set,valign,to,edge/'top',semicolon/';'"]
    ]
  #.........................................................................................................
