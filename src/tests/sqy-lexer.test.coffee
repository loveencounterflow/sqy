...
@[ "basic" ] = ( T, done ) ->
  probes_and_matchers = [
    ...
    ["select fields #myfield, #thatone, .h, A1..B2: set top border to 'thin, blue';","select,fields,id/'#myfield',comma/',',id/'#thatone',comma/',',clasz/'.h',comma/',',cellkey/'A1',upto/'..',cellkey/'B2',colon/':',set,edge/'top',border,to,sq_string/'thin, blue',semicolon/';'"]
    ...
    ["select fields *1: set valign to top;","select,fields,cellkey/'*1',colon/':',set,valign,to,edge/'top',semicolon/';'"]
    ["select fields *: set valign to top;","select,fields,cellkey/'*',colon/':',set,valign,to,edge/'top',semicolon/';'"]
    ["select fields *..*: set valign to top;","select,fields,cellkey/'*',upto/'..',cellkey/'*',colon/':',set,valign,to,edge/'top',semicolon/';'"]
    ["select fields *: set valign to top;","select,fields,cellkey/'*',colon/':',set,valign,to,edge/'top',semicolon/';'"]
