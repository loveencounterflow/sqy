...
(function() {
  ...
  (function() {
     ...
     */
    /*======================================================================================================*/
    var $_show, $assignment, $cellkey, $clasz, $create_layout, $create_named_field, $create_unnamed_field, $filter, $filter_flatten, $first, $first_value, $flatten, $id, $ignore, $last, $only_one, $rangekey, $select_fields, $set_ctx_alignment, $set_ctx_border, $set_debug, $set_grid, $set_sel_alignment, $set_sel_border, CND, _create_field, alert, badge, debug, echo, enumerate, filter, filtered, flatten, get_loc, grammar, help, id, info, join, jr, lexer, log, rpr, show, urge, warn, whisper, Σ;
    id = function(d) {
      return d[0];
    };
    'use strict';
