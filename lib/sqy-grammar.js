...
(function() {
  ...
  (function() {
     ...
     */
    /*======================================================================================================*/
    var $assignment, $cellkey, $clasz, $create_layout, $create_named_field, $create_unnamed_field, $filter, $filter_flatten, $first, $first_value, $flatten, $id, $ignore, $last, $only_one, $rangekey, $select_fields, $set_ctx_alignment, $set_ctx_border, $set_debug, $set_default_gaps, $set_field_gaps, $set_grid, $set_lane_sizes, $set_sel_alignment, $set_sel_background, $set_sel_border, $set_unit_lengths, CND, _create_field, alert, badge, debug, echo, enumerate, filter, filtered, flatten, get_loc, grammar, help, id, info, join, jr, lexer, log, rpr, show, urge, warn, whisper, Σ;
    id = function(d) {
      return d[0];
    };
    'use strict';
    ...
    $set_sel_alignment = function(d) {
      ...
      loc = get_loc(SET);
      if (CND.isa_list(ALIGN)) {
        direction = ALIGN[0].type;
      } else {
        direction = ALIGN.type === 'halign' ? 'horizontal' : 'vertical';
      }
    ...
    //-----------------------------------------------------------------------------------------------------------
    $set_sel_background = function(d) {
      var BACKGROUND, OF, SET, TO, loc, selectors, style, type;
    ...
    $set_unit_lengths = function(d) {
      var SET, TO, UNIT, direction, loc, quantity, type, unit, value;
      // debug 'set_sel_alignment'
      // show d
    ...
    grammar = {
      ...
      ParserRules: [
        ...
        },
        {
          ...
          "postprocess": $set_sel_background
        },
        {
