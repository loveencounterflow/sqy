...
(function() {
  ...
  (function() {
     ...
     */
    /*======================================================================================================*/
    var $cellkey, $clasz, $create_layout, $create_named_field, $create_unnamed_field, $filter, $first, $flatten, $id, $ignore, $rangekey, $select_fields, $set_debug, $set_grid, $set_vname, CND, _create_field, alert, badge, debug, echo, enumerate, filter, filtered, flatten, get_loc, grammar, help, id, info, join, jr, lexer, log, rpr, show, urge, warn, whisper, Σ;
    id = function(d) {
      return d[0];
    };
    'use strict';
    ...
    $set_grid = function(d, loc) {
      var GRID, SET, TO, cellkey, size, type;
    ...
    //-----------------------------------------------------------------------------------------------------------
    $set_vname = function(d, loc) {
      var SET, TO, type, value, vname;
      [SET, vname, TO, value] = filtered(d);
      loc = get_loc(SET);
      type = 'set_vname';
      id = vname.value;
      value = value.value;
      return {type, id, value, loc};
    };
    
    //-----------------------------------------------------------------------------------------------------------
    $set_debug = function(d, loc) {
      var DEBUG, SET, TO, toggle, type, value;
