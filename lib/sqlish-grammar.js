...
(function() {
  ...
  (function() {
     ...
     */
    /*======================================================================================================*/
    var $cellkey, $create_layout, $create_named_field, $create_unnamed_field, $filter, $first, $flatten, $ignore, $name, $rangekey, $select_fields, $set_debug, $set_grid, CND, _create_field, alert, badge, debug, echo, enumerate, filter, filtered, flatten, get_loc, grammar, help, id, info, join, jr, lexer, log, rpr, show, urge, warn, whisper, Σ;
    id = function(d) {
      return d[0];
    };
    'use strict';
    ...
    //-----------------------------------------------------------------------------------------------------------
    _create_field = function(first, selector, identifier) {
      var loc, type;
      loc = get_loc(first);
      type = 'create_field';
    ...
    $create_named_field = function(d) {
      var AT, CREATE, FIELD, identifier, selector;
    ...
    grammar = {
      ...
      ParserRules: [
        ...
        },
        {
          ...
          "symbols": [(lexer.has("id") ? {type: "id"} : id)],
          "postprocess": $first
        },
        {
          "name": "cell_selector",
        ...
        {
          "name": "cell_selector",
          "symbols": [(lexer.has("star") ? {type: "star"} : star)],
          "postprocess": $first
        },
        {
          "name": "cellkey$subexpression$1",
          "symbols": [(lexer.has("colletters") ? {type: "colletters"} : colletters)]
        },
        {
          "name": "cellkey$subexpression$1",
          "symbols": [
        ...
        },
        {
          ...
          "symbols": [(lexer.has("rowdigits") ? {type: "rowdigits"} : rowdigits)]
        },
        {
          "name": "cellkey$subexpression$2",
          "symbols": [
