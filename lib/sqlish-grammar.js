...
(function() {
  ...
  (function() {
     ...
     */
    /*======================================================================================================*/
    var $cellkey, $create_layout, $create_named_field, $create_unnamed_field, $filter, $first, $ignore, $name, $rangekey, $set_debug, $set_grid, CND, _create_field, alert, badge, debug, echo, enumerate, filter, filtered, flatten, get_loc, grammar, help, id, info, join, jr, lexer, log, rpr, show, urge, warn, whisper, Σ;
    id = function(d) {
      return d[0];
    };
    'use strict';
